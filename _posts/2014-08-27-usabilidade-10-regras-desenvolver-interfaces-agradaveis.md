...
![Telefone antigo: simples e fácil de ser utilizado](/assets/imgs/telefone.jpg){:.img-fluid.rounded}
...
![Barra de ferramentas do Microsoft Word, Excel e Powerpoint, um sobre o outro.](/assets/imgs/word-excel-powerpoint.jpg){:.img-fluid.rounded}
...
![Duas versões de um mesmo formulário, uma cheia de informações e outra simples, fácil.](/assets/imgs/exemplo-2.gif){:.img-fluid.rounded}
...
![Pasta com várias abas.](/assets/imgs/pasta.jpg){:.img-fluid.rounded}
...
![Animação mostrando o processo de organização da informação.](/assets/imgs/organizar-informacao.gif){:.img-fluid.rounded}
...
![Pesquisa sem resultados que não demonstra feedback ao usuário.](/assets/imgs/pesquisa-sem-resultado.gif){:.img-fluid.rounded}
...
![Pesquisa sem resultados que demonstra feedback ao usuário: nenhum registro encontrado.](/assets/imgs/pesquisa-sem-resultado-bom.gif){:.img-fluid.rounded}
...
![Caixa de confirmação utilizando-se das cores e icones para facilitar seu uso.](/assets/imgs/usabilidade-uso-das-cores.gif){:.img-fluid.rounded}
...
![Exemplo de ação que não dá a opção do usuário cancelar sua solicitação.](/assets/imgs/controle-liberdade-evitar.gif){:.img-fluid.rounded}
...
![Exemplo de ação que ao clicar, permite o usuário cancelar sua solicitação.](/assets/imgs/controle-liberdade-bomuso.gif){:.img-fluid.rounded}
...
![Funcionalidade que ao ser acionada o sistema não fornece feedback.](/assets/imgs/sistema-respondendo-usuario-evitar.gif){:.img-fluid.rounded}
...
![Funcionalidade que ao ser acionada fornece feedback ao usuário.](/assets/imgs/sistema-respondendo-usuario-bomexemplo.gif){:.img-fluid.rounded}

Uma interface agradável conversa com o usuário, o instrui sempre que necessário e fornece <em>feedbacks</em> a cada ação: sucesso, alertas e erros.

![Exemplos de mensagens de alerta, sucesso, erro e informação.](/assets/imgs/informacao-sucesso-alerta-erro.jpg){:.img-fluid.rounded}
